...
SOURCES = \
	__init__.py \
	geosimulation_land_changes.py geosimulation_land_changes_dialog.py

PLUGINNAME = geosimulation_land_changes

PY_FILES = \
	__init__.py \
	geosimulation_land_changes.py geosimulation_land_changes_dialog.py

UI_FILES = geosimulation_land_changes_dialog_base.ui
